...
const STARTING_FORMATION: Position[] = ["GK", "LB", "CB", "CB", "RB", "LM", "CM", "CM", "RM", "ST", "ST"];
...
function buildPlayer(rng: Rng, teamId: string, index: number, position: Position, avgOverall: number): MatchPlayerInput {
  ...
  return {
    ...
    shooting: isGoalkeeper ? randomAttribute(rng, avgOverall - 20) : randomAttribute(rng, avgOverall),
    passing: randomAttribute(rng, avgOverall),
    dribbling: isGoalkeeper ? randomAttribute(rng, avgOverall - 20) : randomAttribute(rng, avgOverall),
    defending: isGoalkeeper ? randomAttribute(rng, avgOverall - 20) : randomAttribute(rng, avgOverall),
