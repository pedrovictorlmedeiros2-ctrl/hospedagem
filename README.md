...
| `/jogar-carreira` | Joga a próxima rodada agendada da liga — pausa duas vezes (intervalo e aos 70') pra você escolher a postura tática (ofensiva/equilibrada/defensiva) pelos botões; persiste no banco, atualiza classificação/estatísticas, paga recompensa em coins e pode promover/lesionar o jogador |
